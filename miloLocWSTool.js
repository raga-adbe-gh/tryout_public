class MiloLocWSTool {
    ...
    async taskComplete(tids) {
        var cids = []
        for(var c1=0; c1 < tids.length; c1++) {
            cids.push({id:tids[c1], "transitionId": this.transitionId, comment: 'Complete tasks from automated api.'});
        }
